...
Dodaj w dowonlym, widocznym miejscu obiekt `Trritory` - jego parametry graficzne zawierają główne parametry modelu. Pracę przewozową w pojazdogodzinach, pojazdokilometrach, oraz prędkość średnią.
